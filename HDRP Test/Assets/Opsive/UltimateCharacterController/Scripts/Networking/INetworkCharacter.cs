...
namespace Opsive.UltimateCharacterController.Networking.Character
{
    ...
    public interface INetworkCharacter
    {
        ...
        void ShootableHitscanDamage(ItemAction itemAction, GameObject hitGameObject, float damageAmount, Vector3 position, Vector3 direction, float strength, Collider hitCollider);
#endif
