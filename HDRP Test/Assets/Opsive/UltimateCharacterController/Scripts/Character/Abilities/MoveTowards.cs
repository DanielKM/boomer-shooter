...
namespace Opsive.UltimateCharacterController.Character.Abilities
{
    ...
    public class MoveTowards : Ability
    {
        ...
        [Tooltip("Should the character be teleported after the character has been inactive? If false the character will stop.")]
        [SerializeField] protected bool m_TeleportOnTimeout = true;
        ...
        public bool TeleportOnTimeout { get { return m_TeleportOnTimeout; } set { m_TeleportOnTimeout = value; } }
