    ...
    public class PersistablePresetInspector : InspectorBase
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (objType != null) {
                ...
                Utility.ObjectInspector.DrawProperties(objType, null, 0, valuePositionMap, preset.Data, m_Visiblity, () => { GUILayout.BeginHorizontal(); }, (int index, List<int> unityObjectIndexes) =>
                {
