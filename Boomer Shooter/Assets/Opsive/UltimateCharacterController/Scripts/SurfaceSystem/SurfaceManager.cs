    ...
    public class SurfaceManager : MonoBehaviour
    {
        ...
        private Texture GetMainTexture(Collider collider)
        {
            ...
            if (!m_ColliderMainTextureMap.TryGetValue(collider, out texture)) {
                ...
                var renderer = GetRenderer(collider);
                if (renderer != null && renderer.sharedMaterial != null && renderer.sharedMaterial.HasProperty(m_MainTexturePropertyID)) {
                    texture = renderer.sharedMaterial.GetTexture(m_MainTexturePropertyID);
                }
