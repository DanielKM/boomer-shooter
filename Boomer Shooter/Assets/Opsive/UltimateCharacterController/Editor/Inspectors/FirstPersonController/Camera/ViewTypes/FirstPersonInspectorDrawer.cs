        ...
        public override void OnInspectorGUI(object target, Object parent)
        {
            ...
            if (Shared.Editor.Inspectors.Utility.InspectorUtility.Foldout(target, "Rendering")) {
                ...
                var lookOffset = EditorGUILayout.Vector3Field(
                    new GUIContent(Shared.Editor.Utility.EditorUtility.SplitCamelCase("m_LookOffset"), InspectorUtility.GetFieldTooltip(target, "m_LookOffset")), lookOffsetValue);
                ...
                if (drawFirstPersonCamera && Shared.Editor.Inspectors.Utility.InspectorUtility.Foldout(target, "First Person Camera")) {
                    ...
                    var positionOffset = EditorGUILayout.Vector3Field(new GUIContent(
                        Shared.Editor.Utility.EditorUtility.SplitCamelCase("m_FirstPersonPositionOffset"), InspectorUtility.GetFieldTooltip(target, "m_FirstPersonPositionOffset")), positionOffsetValue);
                    // Set the property if the game is playing so the camera will update.
                    ...
                    var rotationOffset = EditorGUILayout.Vector3Field(new GUIContent(
                        Shared.Editor.Utility.EditorUtility.SplitCamelCase("m_FirstPersonRotationOffset"), InspectorUtility.GetFieldTooltip(target, "m_FirstPersonRotationOffset")), rotationOffsetValue);
            ...
            if (Shared.Editor.Inspectors.Utility.InspectorUtility.Foldout(target, "Primary Spring")) {
                ...
                var lowerLimitValue = EditorGUILayout.Slider(new GUIContent(
                                        Shared.Editor.Utility.EditorUtility.SplitCamelCase("m_PositionLowerVerticalLimit"), 
